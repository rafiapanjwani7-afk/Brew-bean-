...
export default function HomePage({ menuData, onAddToCart }) {
  ...
  return (
    <div className="bg-[#FAF7F2] text-[#3B2922]">
      ...
      {/* Hero Section */}
      <section className="relative min-h-[85vh] flex items-center px-6 md:px-12 py-16 overflow-hidden">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center z-10">
          
          <div className="space-y-6">
            <div className="inline-flex items-center space-x-2 px-3 py-1.5 bg-[#EADFCF]/60 rounded-full border border-[#C68B59]/30">
            ...
            <h1 className="text-4xl md:text-6xl font-serif font-bold text-[#3B2922] leading-tight">
              Sip the Craft, <br />
            ...
            <div className="flex flex-wrap items-center gap-4 pt-4">
              <Link
                to="/products"
                className="px-8 py-3.5 bg-[#3B2922] text-[#FAF7F2] text-xs font-bold tracking-widest rounded-xl hover:bg-[#C68B59] transition-all shadow-lg flex items-center space-x-2 group"
              >
              ...
              <Link
                to="/about"
                className="px-8 py-3.5 border border-[#3B2922]/30 text-[#3B2922] text-xs font-bold tracking-widest rounded-xl hover:bg-[#EFEBE4] transition-all"
              >
                OUR STORY
              </Link>
            </div>
          ...
          <div className="relative">
            ...
            {/* Floating Tag */}
            <div className="absolute -bottom-6 -left-6 bg-white p-5 rounded-2xl shadow-xl border border-[#EADFCF] hidden sm:flex items-center space-x-4">
              <div className="p-3 bg-[#FAF7F2] text-[#C68B59] rounded-xl">
                <Flame size={24} />
              </div>
              <div>
                <p className="text-xs font-bold text-[#3B2922]">Freshly Roasted</p>
                <p className="text-[10px] text-[#6B5E57]">Batch #104 Roasted Today</p>
              </div>
            </div>
          </div>
